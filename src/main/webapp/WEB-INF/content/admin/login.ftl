<#assign title = "${options['blog.name']!} &rsaquo; 登陆">
<#include "../common/window.ftl" />
<@window "admin" "login-layout blur-login">
                ...
                <div class="login-container">
                    <div class="center">
                        <h1>
                            ...
                            <span class="white" id="id-text2">博客后台管理</span>
                        </h1>
                        <h4 class="light-blue" id="id-company-text">&copy; ${options['blog.name']!}</h4>
                    </div>
